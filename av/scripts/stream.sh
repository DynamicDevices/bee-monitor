...
/opt/vc/bin/raspivid -o - -t 0 -w 1280 -h 720 -fps 25 -b 6000000 | ffmpeg -f alsa -thread_queue_size 1024 -ac 1 -i hw:1 -f h264 -i - -vcodec copy -c:a aac -ar 44100 -b:a 128k -f flv rtmp://a.rtmp.youtube.com/live2/${STREAM_KEY}
  sleep 10
